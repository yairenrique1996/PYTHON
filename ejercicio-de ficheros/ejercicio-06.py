...
#   el teléfono de un cliente. El listín debe estar guardado en el fichero de texto listin.txt 
#   donde el nombre del cliente y su teléfono deben aparecer separados por comas y cada cliente 
#   en una línea
#  distinta.
